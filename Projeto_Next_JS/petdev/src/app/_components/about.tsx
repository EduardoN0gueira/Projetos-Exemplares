        ...
        <section className="bg-[#FDF6ec] py-16">
            ...
            items-center">
                    ...
                    data-aos-delay="300">
                        ...
                        <p>
                            Cuidamos do seu pet com amor e carinho, oferecendo tudo o que
                            ele precisa para ser feliz e saudável!
                        </p>
                        ...
                        <div className="flex gap-2">
                            ...
                            <a href={`https://wa.me/5567999999999?text=Olá vim pelo site e gostaria de mais informações`}
                        target='_blank'
                                className="bg-[#E84C3D] text-white flex
